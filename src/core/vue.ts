...
export async function vueInit() {
  ...
  if (getEnv('isVue3')) {
    ...
    writeInPackageJson(
      ['vue-loader@^17.0.0', '@vue/compiler-sfc@^3.2.37'],
      'devDependencies'
    )
    ...
    packageJson.scripts['start'] =
      'webpack-dev-server --config build/webpack.base.js'
    packageJson.scripts['build'] =
      'cross-env NODE_ENV=production webpack --config build/webpack.base.js'
